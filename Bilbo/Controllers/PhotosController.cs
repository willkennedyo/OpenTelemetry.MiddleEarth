...
namespace Gandalf.Controllers
{
    ...
    public class PhotosController : BilboBaseController
    {
        ...
        public PhotosController(IHttpContextAccessor httpContextAccessor, PhotoDbContext photoDbContext, ComputerVisionService computerVisionService, AzureStorageService azureStorageService) : base(httpContextAccessor)
        {
